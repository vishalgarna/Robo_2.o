...
import { MetaApiOpts, RefreshSubscriptionsOpts } from "./metaApi";
...
export default class StreamingMetaApiConnection extends MetaApiConnection {
   ...
   */
  constructor(options: MetaApiOpts, websocketClient: MetaApiWebsocketClient, terminalHashManager: TerminalHashManager,

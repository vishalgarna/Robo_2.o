...
let EquityTrackingClient = class EquityTrackingClient {
   ...
   */ getEquityChart(accountId, startTime, endTime, realTime = false, fillSkips = false) {
        var _this = this;
        return _async_to_generator(function*() {
            const records = yield _this._domainClient.requestApi({

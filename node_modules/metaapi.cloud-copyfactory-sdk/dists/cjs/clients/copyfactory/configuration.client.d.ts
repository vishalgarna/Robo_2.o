...
export default class ConfigurationClient extends MetaApiClient {
   ...
   */
  getStrategiesWithClassicPagination(options?: GetStrategiesOptions):
   ...
   * found
   */
  getPortfolioStrategiesWithInfiniteScrollPagination(options?: GetPortfolioStrategiesOptions):
   ...
   * @return {Promise<ClassicPaginationList<CopyFactoryStrategy>>} promise resolving with CopyFactory strategies found
   */
  getPortfolioStrategiesWithClassicPagination(options?: GetPortfolioStrategiesOptions):
    Promise<ClassicPaginationList<CopyFactoryStrategy>>;
   ...
   */
  getSubscribersWithClassicPagination(options?: GetSubscribersOptions):
...
export declare type GetStrategiesOptions = {
  ...
  /**
   * copy trading strategy id. Defaults to 0. Must be greater or equal to 0
   */
  offset?: number
}
